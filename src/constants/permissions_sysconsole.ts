...
export const RESOURCE_KEYS = {
    ...
    EXPERIMENTAL: {
        ...
        FEATURE_FLAG: 'experimental.feature_flags',
...
export const ResourceToSysConsolePermissionsTable: Record<string, string[]> = {
    ...
    [RESOURCE_KEYS.EXPERIMENTAL.FEATURE_FLAG] : [Permissions.SYSCONSOLE_READ_EXPERIMENTAL_FEATURE_FLAG, Permissions.SYSCONSOLE_WRITE_EXPERIMENTAL_FEATURE_FLAG],
