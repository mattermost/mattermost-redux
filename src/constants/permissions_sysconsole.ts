...
export const RESOURCE_KEYS = {
    ...
    COMPLIANCE: {
        DATA_RETENTION: 'compliance.data_retention_policy',
...
export const ResourceToSysConsolePermissionsTable: Record<string, string[]> = {
    ...
    [RESOURCE_KEYS.COMPLIANCE.DATA_RETENTION]: [Permissions.SYSCONSOLE_READ_COMPLIANCE_DATA_RETENTION, Permissions.SYSCONSOLE_WRITE_COMPLIANCE_DATA_RETENTION],
