...
export const ResourceToSysConsolePermissionsTable: Record<string, string[]> = {
    ...
    [RESOURCE_KEYS.AUTHENTICATION.GITLAB]: [Permissions.SYSCONSOLE_READ_AUTHENTICATION_GITLAB, Permissions.SYSCONSOLE_WRITE_AUTHENTICATION_GITLAB],
    ...
    [RESOURCE_KEYS.AUTHENTICATION.OAUTH]: [Permissions.SYSCONSOLE_READ_AUTHENTICATION_OAUTH, Permissions.SYSCONSOLE_WRITE_AUTHENTICATION_OAUTH],
