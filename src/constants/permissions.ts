...
const values = {
    ...
    SYSCONSOLE_READ_COMPLIANCE_DATA_RETENTION: 'sysconsole_read_compliance_data_retention',
    SYSCONSOLE_WRITE_COMPLIANCE_DATA_RETENTION: 'sysconsole_write_compliance_data_retention',
...
values.SYSCONSOLE_READ_PERMISSIONS = [
    ...
    values.SYSCONSOLE_READ_COMPLIANCE_DATA_RETENTION,
...
values.SYSCONSOLE_WRITE_PERMISSIONS = [
    ...
    values.SYSCONSOLE_WRITE_COMPLIANCE_DATA_RETENTION,
