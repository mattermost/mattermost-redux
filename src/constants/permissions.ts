...
values.SYSCONSOLE_READ_PERMISSIONS = [
    values.PERMISSION_READ_SYSCONSOLE_ABOUT,
    values.PERMISSION_READ_SYSCONSOLE_REPORTING,
    values.PERMISSION_READ_SYSCONSOLE_USERMANAGEMENT,
    values.PERMISSION_READ_SYSCONSOLE_USERMANAGEMENT_USERS,
    values.PERMISSION_READ_SYSCONSOLE_USERMANAGEMENT_GROUPS,
    values.PERMISSION_READ_SYSCONSOLE_USERMANAGEMENT_TEAMS,
    values.PERMISSION_READ_SYSCONSOLE_USERMANAGEMENT_CHANNELS,
    values.PERMISSION_READ_SYSCONSOLE_USERMANAGEMENT_PERMISSIONS,
    values.PERMISSION_READ_SYSCONSOLE_ENVIRONMENT,
    values.PERMISSION_READ_SYSCONSOLE_SITE,
    values.PERMISSION_READ_SYSCONSOLE_AUTHENTICATION,
    values.PERMISSION_READ_SYSCONSOLE_PLUGINS,
    values.PERMISSION_READ_SYSCONSOLE_INTEGRATIONS,
    values.PERMISSION_READ_SYSCONSOLE_COMPLIANCE,
    values.PERMISSION_READ_SYSCONSOLE_EXPERIMENTAL,
];

values.SYSCONSOLE_WRITE_PERMISSIONS = [
    values.PERMISSION_WRITE_SYSCONSOLE_ABOUT,
    values.PERMISSION_WRITE_SYSCONSOLE_REPORTING,
    values.PERMISSION_WRITE_SYSCONSOLE_USERMANAGEMENT,
    values.PERMISSION_WRITE_SYSCONSOLE_USERMANAGEMENT_USERS,
    values.PERMISSION_WRITE_SYSCONSOLE_USERMANAGEMENT_GROUPS,
    values.PERMISSION_WRITE_SYSCONSOLE_USERMANAGEMENT_TEAMS,
    values.PERMISSION_WRITE_SYSCONSOLE_USERMANAGEMENT_CHANNELS,
    values.PERMISSION_WRITE_SYSCONSOLE_USERMANAGEMENT_PERMISSIONS,
    values.PERMISSION_WRITE_SYSCONSOLE_ENVIRONMENT,
    values.PERMISSION_WRITE_SYSCONSOLE_SITE,
    values.PERMISSION_WRITE_SYSCONSOLE_AUTHENTICATION,
    values.PERMISSION_WRITE_SYSCONSOLE_PLUGINS,
    values.PERMISSION_WRITE_SYSCONSOLE_INTEGRATIONS,
    values.PERMISSION_WRITE_SYSCONSOLE_COMPLIANCE,
    values.PERMISSION_WRITE_SYSCONSOLE_EXPERIMENTAL,
];
