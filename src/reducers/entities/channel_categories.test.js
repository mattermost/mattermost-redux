...
describe('collapsedById', () => {
    test('should store collapse and expand', () => {
        const initialState = {};

        let state = Reducers.collapsedById(
            initialState,
            {
    ...
    test('should remove categories that are deleted', () => {
        const initialState = {
            category1: true,
            category2: false,
        };
