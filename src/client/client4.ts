...
export default class Client4 {
    ...
    createUser = async (user, token, inviteId) => {
        ...
        return this.doFetch(`${this.getUsersRoute()}${buildQueryString(queryParams)}`, {
            method: 'post',
    ...
    promoteGuestToUser = async (userId) => {
        ...
        return this.doFetch(`${this.getUserRoute(userId)}/promote`, {
            method: 'post',
        });
    };
    ...
    updateUserRoles = async (userId, roles) => {
        ...
        return this.doFetch(`${this.getUserRoute(userId)}/roles`, {
            method: 'put',
            body: JSON.stringify({
                roles,
            }),
    ...
    updateUserMfa = async (userId, activate, code) => {
        ...
        return this.doFetch(`${this.getUserRoute(userId)}/mfa`, {
            method: 'put',
    ...
    updateUserPassword = async (userId, currentPassword, newPassword) => {
        ...
        return this.doFetch(`${this.getUserRoute(userId)}/password`, {
            method: 'put',
            body: JSON.stringify({
    ...
    resetUserPassword = async (token, newPassword) => {
        ...
        return this.doFetch(`${this.getUsersRoute()}/password/reset`, {
            method: 'post',
            body: JSON.stringify({
                token,
                new_password: newPassword,
    ...
    updateUserActive = async (userId, active) => {
        ...
        return this.doFetch(`${this.getUserRoute(userId)}/active`, {
            method: 'put',
            body: JSON.stringify({
                active,
            }),
    ...
    verifyUserEmail = async (token) => {
        return this.doFetch(`${this.getUsersRoute()}/email/verify`, {
            method: 'post',
            body: JSON.stringify({
                token,
            }),
    ...
    updateMyTermsOfServiceStatus = async (termsOfServiceId, accepted) => {
        return this.doFetch(`${this.getUserRoute('me')}/terms_of_service`, {
            method: 'post',
            body: JSON.stringify({
                termsOfServiceId,
                accepted,
    ...
    getTermsOfService = async () => {
        return this.doFetch(`${this.getBaseRoute()}/terms_of_service`, {
            method: 'get',
        });
    };
    ...
    sendVerificationEmail = async (email) => {
        return this.doFetch(`${this.getUsersRoute()}/email/verify/send`, {
            method: 'post',
            body: JSON.stringify({
                email,
            }),
    ...
    login = async (loginId, password, token = '', deviceId = '', ldapOnly = false) => {
        ...
        const {
            data,
        } = await this.doFetchWithResponse(`${this.getUsersRoute()}/login`, {
            method: 'post',
            body: JSON.stringify(body),
        });
        return data;
    ...
    logout = async () => {
        ...
        const {
            response,
        } = await this.doFetchWithResponse(`${this.getUsersRoute()}/logout`, {
            method: 'post',
        });
    ...
    getProfiles = async (page = 0, perPage = PER_PAGE_DEFAULT, options = {}) => {
        ...
        return this.doFetch(`${this.getUsersRoute()}${buildQueryString({
            page,
            per_page: perPage,
            ...options,
        })}`, {
    ...
    getProfilesByIds = async (userIds, options = {}) => {
        ...
        return this.doFetch(`${this.getUsersRoute()}/ids${buildQueryString(options)}`, {
            method: 'post',
    ...
    getProfilesInTeam = async (teamId, page = 0, perPage = PER_PAGE_DEFAULT, sort = '', options = {}) => {
        ...
        return this.doFetch(`${this.getUsersRoute()}${buildQueryString({...options,
            in_team: teamId,
            page,
            per_page: perPage,
            sort,
    ...
    getProfilesNotInTeam = async (teamId, groupConstrained, page = 0, perPage = PER_PAGE_DEFAULT) => {
        ...
        return this.doFetch(`${this.getUsersRoute()}${buildQueryString(queryStringObj)}`, {
            method: 'get',
        });
    };
    ...
    getProfilesInGroupChannels = async (channelsIds): Promise<{[x: string]: UserProfile[]}> => {
    ...
    getProfilesNotInChannel = async (teamId, channelId, groupConstrained, page = 0, perPage = PER_PAGE_DEFAULT): Promise<UserProfile[]> => {
    ...
    getMe = async () => {
        return this.doFetch(`${this.getUserRoute('me')}`, {
            method: 'get',
        });
    };
    ...
    getUserByUsername = async (username) => {
        return this.doFetch(`${this.getUsersRoute()}/username/${username}`, {
            method: 'get',
        });
    };
    ...
    revokeSession = async (userId, sessionId) => {
        return this.doFetch(`${this.getUserRoute(userId)}/sessions/revoke`, {
            method: 'post',
            body: JSON.stringify({
    ...
    revokeAllSessionsForUser = async (userId) => {
        return this.doFetch(`${this.getUserRoute(userId)}/sessions/revoke/all`, {
            method: 'post',
        });
    };
    revokeSessionsForAllUsers = async () => {
        return this.doFetch(`${this.getUsersRoute()}/sessions/revoke/all`, {
            method: 'post',
        });
    };
    getUserAudits = async (userId, page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getUserRoute(userId)}/audits${buildQueryString({
            page,
            per_page: perPage,
        })}`, {
            method: 'get',
    ...
    generateMfaSecret = async (userId) => {
        return this.doFetch(`${this.getUserRoute(userId)}/mfa/generate`, {
            method: 'post',
        });
    };
    ...
    switchEmailToOAuth = async (service, email, password, mfaCode = '') => {
        ...
        return this.doFetch(`${this.getUsersRoute()}/login/switch`, {
            method: 'post',
            body: JSON.stringify({
    ...
    getAuthorizedOAuthApps = async (userId) => {
        return this.doFetch(`${this.getUserRoute(userId)}/oauth/apps/authorized`, {
            method: 'get',
        });
    };
    authorizeOAuthApp = async (responseType, clientId, redirectUri, state, scope) => {
        return this.doFetch(`${this.url}/oauth/authorize`, {
            method: 'post',
            body: JSON.stringify({
                client_id: clientId,
    ...
    deauthorizeOAuthApp = async (clientId) => {
        return this.doFetch(`${this.url}/oauth/deauthorize`, {
            method: 'post',
            body: JSON.stringify({
                client_id: clientId,
            }),
    ...
    createUserAccessToken = async (userId, description) => {
        ...
        return this.doFetch(`${this.getUserRoute(userId)}/tokens`, {
            method: 'post',
            body: JSON.stringify({
                description,
            }),
    ...
    getUserAccessToken = async (tokenId) => {
        return this.doFetch(`${this.getUsersRoute()}/tokens/${tokenId}`, {
            method: 'get',
        });
    };
    getUserAccessTokensForUser = async (userId, page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getUserRoute(userId)}/tokens${buildQueryString({
            page,
            per_page: perPage,
        })}`, {
            method: 'get',
    ...
    getUserAccessTokens = async (page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getUsersRoute()}/tokens${buildQueryString({
            page,
            per_page: perPage,
        })}`, {
            method: 'get',
    ...
    revokeUserAccessToken = async (tokenId) => {
        ...
        return this.doFetch(`${this.getUsersRoute()}/tokens/revoke`, {
            method: 'post',
            body: JSON.stringify({
                token_id: tokenId,
            }),
    ...
    disableUserAccessToken = async (tokenId) => {
        return this.doFetch(`${this.getUsersRoute()}/tokens/disable`, {
            method: 'post',
            body: JSON.stringify({
                token_id: tokenId,
            }),
    ...
    enableUserAccessToken = async (tokenId) => {
        return this.doFetch(`${this.getUsersRoute()}/tokens/enable`, {
            method: 'post',
            body: JSON.stringify({
                token_id: tokenId,
            }),
    ...
    updateTeam = async (team) => {
        ...
        return this.doFetch(`${this.getTeamRoute(team.id)}`, {
            method: 'put',
            body: JSON.stringify(team),
        });
    };
    patchTeam = async (team) => {
        ...
        return this.doFetch(`${this.getTeamRoute(team.id)}/patch`, {
            method: 'put',
            body: JSON.stringify(team),
        });
    };
    regenerateTeamInviteId = async (teamId) => {
        ...
        return this.doFetch(`${this.getTeamRoute(teamId)}/regenerate_invite_id`, {
            method: 'post',
        });
    };
    updateTeamScheme = async (teamId, schemeId) => {
        ...
        return this.doFetch(`${this.getTeamSchemeRoute(teamId)}`, {
            method: 'put',
            body: JSON.stringify(patch),
        });
    };
    checkIfTeamExists = async (teamName) => {
        return this.doFetch(`${this.getTeamNameRoute(teamName)}/exists`, {
            method: 'get',
        });
    };
    getTeams = async (page = 0, perPage = PER_PAGE_DEFAULT, includeTotalCount = false) => {
        return this.doFetch(`${this.getTeamsRoute()}${buildQueryString({
            page,
            per_page: perPage,
    ...
    searchTeams = (term) => {
        ...
        return this.doFetch(`${this.getTeamsRoute()}/search`, {
            method: 'post',
            body: JSON.stringify({
                term,
            }),
    ...
    getMyTeams = async () => {
        return this.doFetch(`${this.getUserRoute('me')}/teams`, {
            method: 'get',
        });
    };
    getTeamsForUser = async (userId) => {
        return this.doFetch(`${this.getUserRoute(userId)}/teams`, {
            method: 'get',
        });
    };
    getMyTeamMembers = async () => {
        return this.doFetch(`${this.getUserRoute('me')}/teams/members`, {
            method: 'get',
        });
    };
    getMyTeamUnreads = async () => {
        return this.doFetch(`${this.getUserRoute('me')}/teams/unread`, {
            method: 'get',
        });
    };
    getTeamMembers = async (teamId, page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getTeamMembersRoute(teamId)}${buildQueryString({
            page,
            per_page: perPage,
        })}`, {
            method: 'get',
    ...
    getTeamMembersForUser = async (userId) => {
        return this.doFetch(`${this.getUserRoute(userId)}/teams/members`, {
            method: 'get',
        });
    };
    getTeamMember = async (teamId, userId) => {
        return this.doFetch(`${this.getTeamMemberRoute(teamId, userId)}`, {
            method: 'get',
        });
    };
    getTeamMembersByIds = async (teamId, userIds) => {
        return this.doFetch(`${this.getTeamMembersRoute(teamId)}/ids`, {
            method: 'post',
            body: JSON.stringify(userIds),
        });
    };
    addToTeam = async (teamId, userId) => {
        ...
        return this.doFetch(`${this.getTeamMembersRoute(teamId)}`, {
            method: 'post',
    ...
    addToTeamFromInvite = async (token = '', inviteId = '') => {
        ...
        return this.doFetch(`${this.getTeamsRoute()}/members/invite${query}`, {
            method: 'post',
        });
    };
    addUsersToTeam = async (teamId, userIds) => {
        ...
        return this.doFetch(`${this.getTeamMembersRoute(teamId)}/batch`, {
            method: 'post',
    ...
    getTeamStats = async (teamId) => {
        return this.doFetch(`${this.getTeamRoute(teamId)}/stats`, {
            method: 'get',
        });
    };
    getTotalUsersStats = async () => {
        return this.doFetch(`${this.getUsersRoute()}/stats`, {
            method: 'get',
        });
    };
    invalidateAllEmailInvites = async () => {
        return this.doFetch(`${this.getTeamsRoute()}/invites/email`, {
            method: 'delete',
        });
    };
    getTeamInviteInfo = async (inviteId) => {
        return this.doFetch(`${this.getTeamsRoute()}/invite/${inviteId}`, {
            method: 'get',
        });
    };
    updateTeamMemberRoles = async (teamId, userId, roles) => {
        ...
        return this.doFetch(`${this.getTeamMemberRoute(teamId, userId)}/roles`, {
            method: 'put',
            body: JSON.stringify({
                roles,
            }),
    ...
    sendEmailInvitesToTeam = async (teamId, emails) => {
        ...
        return this.doFetch(`${this.getTeamRoute(teamId)}/invite/email`, {
            method: 'post',
    ...
    sendEmailGuestInvitesToChannels = async (teamId, channelIds, emails, message) => {
        ...
        return this.doFetch(`${this.getTeamRoute(teamId)}/invite-guests/email`, {
            method: 'post',
            body: JSON.stringify({
                emails,
                channels: channelIds,
    ...
    importTeam = async (teamId, file, importFrom) => {
        ...
        return this.doFetch(`${this.getTeamRoute(teamId)}/import`, request);
    };
    ...
    removeTeamIcon = async (teamId) => {
        ...
        return this.doFetch(`${this.getTeamRoute(teamId)}/image`, {
            method: 'delete',
        });
    };
    updateTeamMemberSchemeRoles = async (teamId, userId, isSchemeUser, isSchemeAdmin) => {
        ...
        return this.doFetch(`${this.getTeamRoute(teamId)}/members/${userId}/schemeRoles`, {
            method: 'put',
            body: JSON.stringify(body),
        });
    }; // Channel Routes
    ...
    getAllChannels = async (page = 0, perPage = PER_PAGE_DEFAULT, notAssociatedToGroup = '', excludeDefaultChannels = false, includeTotalCount = false) => {
        ...
        return this.doFetch(`${this.getChannelsRoute()}${buildQueryString(queryData)}`, {
            method: 'get',
        });
    };
    createChannel = async (channel) => {
        ...
        return this.doFetch(`${this.getChannelsRoute()}`, {
            method: 'post',
    ...
    createDirectChannel = async (userIds) => {
        ...
        return this.doFetch(`${this.getChannelsRoute()}/direct`, {
            method: 'post',
            body: JSON.stringify(userIds),
        });
    };
    createGroupChannel = async (userIds) => {
        ...
        return this.doFetch(`${this.getChannelsRoute()}/group`, {
            method: 'post',
            body: JSON.stringify(userIds),
        });
    };
    deleteChannel = async (channelId) => {
        ...
        return this.doFetch(`${this.getChannelRoute(channelId)}`, {
            method: 'delete',
        });
    };
    updateChannel = async (channel) => {
        ...
        return this.doFetch(`${this.getChannelRoute(channel.id)}`, {
            method: 'put',
            body: JSON.stringify(channel),
        });
    };
    convertChannelToPrivate = async (channelId) => {
        ...
        return this.doFetch(`${this.getChannelRoute(channelId)}/convert`, {
            method: 'post',
        });
    };
    updateChannelPrivacy = async (channelId, privacy) => {
        ...
        return this.doFetch(`${this.getChannelRoute(channelId)}/privacy`, {
            method: 'put',
            body: JSON.stringify({
                privacy,
            }),
    ...
    patchChannel = async (channelId, channelPatch) => {
        ...
        return this.doFetch(`${this.getChannelRoute(channelId)}/patch`, {
            method: 'put',
    ...
    updateChannelNotifyProps = async (props) => {
        ...
        return this.doFetch(`${this.getChannelMemberRoute(props.channel_id, props.user_id)}/notify_props`, {
            method: 'put',
    ...
    updateChannelScheme = async (channelId, schemeId) => {
        ...
        return this.doFetch(`${this.getChannelSchemeRoute(channelId)}`, {
            method: 'put',
            body: JSON.stringify(patch),
        });
    };
    ...
    getChannelByName = async (teamId, channelName, includeDeleted = false) => {
        return this.doFetch(`${this.getTeamRoute(teamId)}/channels/name/${channelName}?include_deleted=${includeDeleted}`, {
            method: 'get',
        });
    };
    getChannelByNameAndTeamName = async (teamName, channelName, includeDeleted = false) => {
        ...
        return this.doFetch(`${this.getTeamNameRoute(teamName)}/channels/name/${channelName}?include_deleted=${includeDeleted}`, {
            method: 'get',
        });
    };
    getChannels = async (teamId, page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getTeamRoute(teamId)}/channels${buildQueryString({
            page,
            per_page: perPage,
        })}`, {
            method: 'get',
    ...
    getMyChannels = async (teamId) => {
        return this.doFetch(`${this.getUserRoute('me')}/teams/${teamId}/channels`, {
            method: 'get',
        });
    };
    getMyChannelMember = async (channelId) => {
        return this.doFetch(`${this.getChannelMemberRoute(channelId, 'me')}`, {
            method: 'get',
        });
    };
    getMyChannelMembers = async (teamId) => {
        return this.doFetch(`${this.getUserRoute('me')}/teams/${teamId}/channels/members`, {
            method: 'get',
        });
    };
    getChannelMembers = async (channelId, page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getChannelMembersRoute(channelId)}${buildQueryString({
            page,
            per_page: perPage,
        })}`, {
            method: 'get',
    ...
    getChannelTimezones = async (channelId) => {
        return this.doFetch(`${this.getChannelRoute(channelId)}/timezones`, {
            method: 'get',
        });
    };
    getChannelMember = async (channelId, userId) => {
        return this.doFetch(`${this.getChannelMemberRoute(channelId, userId)}`, {
            method: 'get',
        });
    };
    getChannelMembersByIds = async (channelId, userIds) => {
        return this.doFetch(`${this.getChannelMembersRoute(channelId)}/ids`, {
            method: 'post',
            body: JSON.stringify(userIds),
        });
    };
    addToChannel = async (userId, channelId, postRootId = '') => {
        ...
        return this.doFetch(`${this.getChannelMembersRoute(channelId)}`, {
            method: 'post',
            body: JSON.stringify(member),
        });
    };
    ...
    updateChannelMemberRoles = async (channelId, userId, roles) => {
        return this.doFetch(`${this.getChannelMemberRoute(channelId, userId)}/roles`, {
            method: 'put',
            body: JSON.stringify({
                roles,
            }),
    ...
    getChannelStats = async (channelId) => {
        return this.doFetch(`${this.getChannelRoute(channelId)}/stats`, {
            method: 'get',
        });
    };
    viewMyChannel = async (channelId, prevChannelId) => {
        ...
        return this.doFetch(`${this.getChannelsRoute()}/members/me/view`, {
            method: 'post',
            body: JSON.stringify(data),
        });
    };
    autocompleteChannels = async (teamId, name) => {
        return this.doFetch(`${this.getTeamRoute(teamId)}/channels/autocomplete${buildQueryString({
            name,
        })}`, {
            method: 'get',
        });
    ...
    autocompleteChannelsForSearch = async (teamId, name) => {
        return this.doFetch(`${this.getTeamRoute(teamId)}/channels/search_autocomplete${buildQueryString({
            name,
        })}`, {
            method: 'get',
        });
    ...
    searchChannels = async (teamId, term) => {
        return this.doFetch(`${this.getTeamRoute(teamId)}/channels/search`, {
            method: 'post',
            body: JSON.stringify({
                term,
            }),
    ...
    searchAllChannels = async (term, notAssociatedToGroup = '', excludeDefaultChannels = false) => {
        ...
        return this.doFetch(`${this.getChannelsRoute()}/search`, {
            method: 'post',
            body: JSON.stringify(body),
        });
    };
    searchGroupChannels = async (term) => {
        return this.doFetch(`${this.getChannelsRoute()}/group/search`, {
            method: 'post',
            body: JSON.stringify({
                term,
            }),
    ...
    updateChannelMemberSchemeRoles = async (channelId, userId, isSchemeUser, isSchemeAdmin) => {
        ...
        return this.doFetch(`${this.getChannelRoute(channelId)}/members/${userId}/schemeRoles`, {
            method: 'put',
            body: JSON.stringify(body),
        });
    }; // Post Routes
    ...
    createPost = async (post) => {
        ...
        return this.doFetch(`${this.getPostsRoute()}`, {
            method: 'post',
    ...
    updatePost = async (post) => {
        ...
        return this.doFetch(`${this.getPostRoute(post.id)}`, {
            method: 'put',
            body: JSON.stringify(post),
        });
    };
    getPost = async (postId) => {
        return this.doFetch(`${this.getPostRoute(postId)}`, {
            method: 'get',
        });
    };
    patchPost = async (postPatch) => {
        ...
        return this.doFetch(`${this.getPostRoute(postPatch.id)}/patch`, {
            method: 'put',
    ...
    getPostThread = async (postId, fetchThreads = true) => {
        return this.doFetch(`${this.getPostRoute(postId)}/thread${buildQueryString({
            fetchThreads,
        })}`, {
            method: 'get',
        });
    };
    getPosts = async (channelId, page = 0, perPage = PER_PAGE_DEFAULT, fetchThreads = true) => {
        return this.doFetch(`${this.getChannelRoute(channelId)}/posts${buildQueryString({
            page,
            per_page: perPage,
            fetchThreads,
        })}`, {
    ...
    getPostsUnread = async (channelId, userId, limitAfter = DEFAULT_LIMIT_AFTER, limitBefore = DEFAULT_LIMIT_BEFORE, fetchThreads = true) => {
        return this.doFetch(`${this.getUserRoute(userId)}/channels/${channelId}/posts/unread${buildQueryString({
    ...
    getPostsSince = async (channelId, since, fetchThreads = true) => {
        return this.doFetch(`${this.getChannelRoute(channelId)}/posts${buildQueryString({
            since,
            fetchThreads,
        })}`, {
    ...
    getPostsBefore = async (channelId, postId, page = 0, perPage = PER_PAGE_DEFAULT, fetchThreads = true) => {
    ...
    getPostsAfter = async (channelId, postId, page = 0, perPage = PER_PAGE_DEFAULT, fetchThreads = true) => {
    ...
    getFileInfosForPost = async (postId) => {
        return this.doFetch(`${this.getPostRoute(postId)}/files/info`, {
            method: 'get',
        });
    };
    getFlaggedPosts = async (userId, channelId = '', teamId = '', page = 0, perPage = PER_PAGE_DEFAULT) => {
        ...
        return this.doFetch(`${this.getUserRoute(userId)}/posts/flagged${buildQueryString({
            channel_id: channelId,
            team_id: teamId,
            page,
            per_page: perPage,
    ...
    getPinnedPosts = async (channelId) => {
        ...
        return this.doFetch(`${this.getChannelRoute(channelId)}/pinned`, {
            method: 'get',
        });
    };
    pinPost = async (postId) => {
        this.trackEvent('api', 'api_posts_pin');
        return this.doFetch(`${this.getPostRoute(postId)}/pin`, {
            method: 'post',
        });
    };
    unpinPost = async (postId) => {
        this.trackEvent('api', 'api_posts_unpin');
        return this.doFetch(`${this.getPostRoute(postId)}/unpin`, {
            method: 'post',
        });
    };
    addReaction = async (userId, postId, emojiName) => {
        ...
        return this.doFetch(`${this.getReactionsRoute()}`, {
            method: 'post',
            body: JSON.stringify({
                user_id: userId,
                post_id: postId,
    ...
    removeReaction = async (userId, postId, emojiName) => {
        ...
        return this.doFetch(`${this.getUserRoute(userId)}/posts/${postId}/reactions/${emojiName}`, {
            method: 'delete',
        });
    };
    getReactionsForPost = async (postId) => {
        return this.doFetch(`${this.getPostRoute(postId)}/reactions`, {
            method: 'get',
        });
    };
    searchPostsWithParams = async (teamId, params) => {
        ...
        return this.doFetch(`${this.getTeamRoute(teamId)}/posts/search`, {
            method: 'post',
    ...
    getOpenGraphMetadata = async (url) => {
        return this.doFetch(`${this.getBaseRoute()}/opengraph`, {
            method: 'post',
            body: JSON.stringify({
                url,
            }),
    ...
    doPostActionWithCookie = async (postId, actionId, actionCookie, selectedOption = '') => {
        ...
        return this.doFetch(`${this.getPostRoute(postId)}/actions/${encodeURIComponent(actionId)}`, {
            method: 'post',
    ...
    getFilePublicLink = async (fileId) => {
        return this.doFetch(`${this.getFileRoute(fileId)}/link`, {
            method: 'get',
        });
    }; // Preference Routes
    ...
    getMyPreferences = async () => {
        return this.doFetch(`${this.getPreferencesRoute('me')}`, {
            method: 'get',
        });
    };
    ...
    getClientConfigOld = async () => {
        return this.doFetch(`${this.getBaseRoute()}/config/client?format=old`, {
            method: 'get',
        });
    };
    getClientLicenseOld = async () => {
        return this.doFetch(`${this.getBaseRoute()}/license/client?format=old`, {
            method: 'get',
        });
    };
    ...
    webrtcToken = async () => {
        return this.doFetch(`${this.getBaseRoute()}/webrtc/token`, {
            method: 'get',
        });
    }; // Integration Routes
    ...
    createIncomingWebhook = async (hook) => {
        ...
        return this.doFetch(`${this.getIncomingHooksRoute()}`, {
            method: 'post',
            body: JSON.stringify(hook),
        });
    };
    getIncomingWebhook = async (hookId) => {
        return this.doFetch(`${this.getIncomingHookRoute(hookId)}`, {
            method: 'get',
        });
    };
    getIncomingWebhooks = async (teamId = '', page = 0, perPage = PER_PAGE_DEFAULT) => {
        ...
        return this.doFetch(`${this.getIncomingHooksRoute()}${buildQueryString(queryParams)}`, {
            method: 'get',
        });
    };
    ...
    updateIncomingWebhook = async (hook) => {
        ...
        return this.doFetch(`${this.getIncomingHookRoute(hook.id)}`, {
            method: 'put',
            body: JSON.stringify(hook),
        });
    };
    createOutgoingWebhook = async (hook) => {
        ...
        return this.doFetch(`${this.getOutgoingHooksRoute()}`, {
            method: 'post',
            body: JSON.stringify(hook),
        });
    };
    getOutgoingWebhook = async (hookId) => {
        return this.doFetch(`${this.getOutgoingHookRoute(hookId)}`, {
            method: 'get',
        });
    };
    getOutgoingWebhooks = async (channelId = '', teamId = '', page = 0, perPage = PER_PAGE_DEFAULT) => {
        ...
        return this.doFetch(`${this.getOutgoingHooksRoute()}${buildQueryString(queryParams)}`, {
            method: 'get',
        });
    };
    ...
    updateOutgoingWebhook = async (hook) => {
        ...
        return this.doFetch(`${this.getOutgoingHookRoute(hook.id)}`, {
            method: 'put',
            body: JSON.stringify(hook),
        });
    };
    regenOutgoingHookToken = async (id) => {
        return this.doFetch(`${this.getOutgoingHookRoute(id)}/regen_token`, {
            method: 'post',
        });
    };
    getCommandsList = async (teamId) => {
        return this.doFetch(`${this.getCommandsRoute()}?team_id=${teamId}`, {
            method: 'get',
        });
    };
    getAutocompleteCommandsList = async (teamId, page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getTeamRoute(teamId)}/commands/autocomplete${buildQueryString({
            page,
            per_page: perPage,
        })}`, {
            method: 'get',
    ...
    getCustomTeamCommands = async (teamId) => {
        return this.doFetch(`${this.getCommandsRoute()}?team_id=${teamId}&custom_only=true`, {
            method: 'get',
        });
    };
    executeCommand = async (command, commandArgs = {}) => {
        this.trackEvent('api', 'api_integrations_used');
        return this.doFetch(`${this.getCommandsRoute()}/execute`, {
            method: 'post',
            body: JSON.stringify({
                command,
                ...commandArgs,
    ...
    addCommand = async (command) => {
        this.trackEvent('api', 'api_integrations_created');
        return this.doFetch(`${this.getCommandsRoute()}`, {
            method: 'post',
    ...
    editCommand = async (command) => {
        this.trackEvent('api', 'api_integrations_created');
        return this.doFetch(`${this.getCommandsRoute()}/${command.id}`, {
            method: 'put',
            body: JSON.stringify(command),
        });
    };
    regenCommandToken = async (id) => {
        return this.doFetch(`${this.getCommandsRoute()}/${id}/regen_token`, {
            method: 'put',
        });
    };
    deleteCommand = async (id) => {
        this.trackEvent('api', 'api_integrations_deleted');
        return this.doFetch(`${this.getCommandsRoute()}/${id}`, {
            method: 'delete',
        });
    };
    createOAuthApp = async (app) => {
        this.trackEvent('api', 'api_apps_register');
        return this.doFetch(`${this.getOAuthAppsRoute()}`, {
            method: 'post',
            body: JSON.stringify(app),
        });
    };
    editOAuthApp = async (app) => {
        return this.doFetch(`${this.getOAuthAppsRoute()}/${app.id}`, {
            method: 'put',
            body: JSON.stringify(app),
        });
    };
    getOAuthApps = async (page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getOAuthAppsRoute()}${buildQueryString({
            page,
            per_page: perPage,
        })}`, {
            method: 'get',
    ...
    getOAuthApp = async (appId) => {
        return this.doFetch(`${this.getOAuthAppRoute(appId)}`, {
            method: 'get',
        });
    };
    getOAuthAppInfo = async (appId) => {
        return this.doFetch(`${this.getOAuthAppRoute(appId)}/info`, {
            method: 'get',
        });
    };
    ...
    regenOAuthAppSecret = async (appId) => {
        return this.doFetch(`${this.getOAuthAppRoute(appId)}/regen_secret`, {
            method: 'post',
        });
    };
    submitInteractiveDialog = async (data) => {
        this.trackEvent('api', 'api_interactive_messages_dialog_submitted');
        return this.doFetch(`${this.getBaseRoute()}/actions/dialogs/submit`, {
            method: 'post',
            body: JSON.stringify(data),
        });
    }; // Emoji Routes
    ...
    getCustomEmoji = async (id) => {
        return this.doFetch(`${this.getEmojisRoute()}/${id}`, {
            method: 'get',
        });
    };
    getCustomEmojiByName = async (name) => {
        return this.doFetch(`${this.getEmojisRoute()}/name/${name}`, {
            method: 'get',
        });
    };
    getCustomEmojis = async (page = 0, perPage = PER_PAGE_DEFAULT, sort = '') => {
        return this.doFetch(`${this.getEmojisRoute()}${buildQueryString({
            page,
            per_page: perPage,
            sort,
        })}`, {
    ...
    deleteCustomEmoji = async (emojiId) => {
        ...
        return this.doFetch(`${this.getEmojiRoute(emojiId)}`, {
            method: 'delete',
        });
    };
    ...
    searchCustomEmoji = async (term, options = {}) => {
        return this.doFetch(`${this.getEmojisRoute()}/search`, {
            method: 'post',
            body: JSON.stringify({
                term,
                ...options,
    ...
    autocompleteCustomEmoji = async (name) => {
        return this.doFetch(`${this.getEmojisRoute()}/autocomplete${buildQueryString({
            name,
        })}`, {
            method: 'get',
        });
    ...
    getTimezones = async () => {
        return this.doFetch(`${this.getTimezonesRoute()}`, {
            method: 'get',
        });
    }; // Data Retention

    getDataRetentionPolicy = () => {
        return this.doFetch(`${this.getDataRetentionRoute()}/policy`, {
            method: 'get',
        });
    }; // Jobs Routes

    getJob = async (id) => {
        return this.doFetch(`${this.getJobsRoute()}/${id}`, {
            method: 'get',
        });
    };
    getJobs = async (page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getJobsRoute()}${buildQueryString({
            page,
            per_page: perPage,
        })}`, {
            method: 'get',
    ...
    getJobsByType = async (type, page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getJobsRoute()}/type/${type}${buildQueryString({
            page,
            per_page: perPage,
        })}`, {
            method: 'get',
    ...
    createJob = async (job) => {
        return this.doFetch(`${this.getJobsRoute()}`, {
            method: 'post',
            body: JSON.stringify(job),
        });
    };
    cancelJob = async (id) => {
        return this.doFetch(`${this.getJobsRoute()}/${id}/cancel`, {
            method: 'post',
        });
    }; // Admin Routes

    getLogs = async (page = 0, perPage = LOGS_PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getBaseRoute()}/logs${buildQueryString({
            page,
    ...
    getAudits = async (page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getBaseRoute()}/audits${buildQueryString({
            page,
            per_page: perPage,
        })}`, {
            method: 'get',
    ...
    getConfig = async () => {
        return this.doFetch(`${this.getBaseRoute()}/config`, {
            method: 'get',
        });
    };
    ...
    reloadConfig = async () => {
        return this.doFetch(`${this.getBaseRoute()}/config/reload`, {
            method: 'post',
        });
    };
    getEnvironmentConfig = async () => {
        return this.doFetch(`${this.getBaseRoute()}/config/environment`, {
            method: 'get',
        });
    };
    testEmail = async (config) => {
        return this.doFetch(`${this.getBaseRoute()}/email/test`, {
            method: 'post',
            body: JSON.stringify(config),
        });
    };
    testSiteURL = async (siteURL) => {
        return this.doFetch(`${this.getBaseRoute()}/site_url/test`, {
            method: 'post',
            body: JSON.stringify({
                site_url: siteURL,
            }),
    ...
    testS3Connection = async (config) => {
        return this.doFetch(`${this.getBaseRoute()}/file/s3_test`, {
            method: 'post',
            body: JSON.stringify(config),
        });
    };
    invalidateCaches = async () => {
        return this.doFetch(`${this.getBaseRoute()}/caches/invalidate`, {
            method: 'post',
        });
    };
    recycleDatabase = async () => {
        return this.doFetch(`${this.getBaseRoute()}/database/recycle`, {
            method: 'post',
        });
    };
    createComplianceReport = async (job) => {
        return this.doFetch(`${this.getBaseRoute()}/compliance/reports`, {
            method: 'post',
            body: JSON.stringify(job),
        });
    };
    getComplianceReport = async (reportId) => {
        return this.doFetch(`${this.getBaseRoute()}/compliance/reports/${reportId}`, {
            method: 'get',
        });
    };
    getComplianceReports = async (page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getBaseRoute()}/compliance/reports${buildQueryString({
            page,
            per_page: perPage,
        })}`, {
            method: 'get',
    ...
    deleteBrandImage = async () => {
        return this.doFetch(`${this.getBrandRoute()}/image`, {
            method: 'delete',
        });
    };
    getClusterStatus = async () => {
        return this.doFetch(`${this.getBaseRoute()}/cluster/status`, {
            method: 'get',
        });
    };
    testLdap = async () => {
        return this.doFetch(`${this.getBaseRoute()}/ldap/test`, {
            method: 'post',
        });
    };
    syncLdap = async () => {
        return this.doFetch(`${this.getBaseRoute()}/ldap/sync`, {
            method: 'post',
        });
    };
    getLdapGroups = async (page = 0, perPage = PER_PAGE_DEFAULT, opts = {}) => {
        ...
        return this.doFetch(`${this.getBaseRoute()}/ldap/groups${buildQueryString(query)}`, {
            method: 'get',
        });
    };
    linkLdapGroup = async (key) => {
        return this.doFetch(`${this.getBaseRoute()}/ldap/groups/${encodeURI(key)}/link`, {
            method: 'post',
        });
    };
    ...
    getSamlCertificateStatus = async () => {
        return this.doFetch(`${this.getBaseRoute()}/saml/certificate/status`, {
            method: 'get',
        });
    };
    ...
    testElasticsearch = async (config) => {
        return this.doFetch(`${this.getBaseRoute()}/elasticsearch/test`, {
            method: 'post',
            body: JSON.stringify(config),
        });
    };
    purgeElasticsearchIndexes = async () => {
        return this.doFetch(`${this.getBaseRoute()}/elasticsearch/purge_indexes`, {
            method: 'post',
        });
    };
    ...
    removeLicense = async () => {
        return this.doFetch(`${this.getBaseRoute()}/license`, {
            method: 'delete',
        });
    };
    getAnalytics = async (name = 'standard', teamId = '') => {
        return this.doFetch(`${this.getBaseRoute()}/analytics/old${buildQueryString({
            name,
            team_id: teamId,
        })}`, {
            method: 'get',
    ...
    getRole = async (roleId) => {
        return this.doFetch(`${this.getRolesRoute()}/${roleId}`, {
            method: 'get',
        });
    };
    getRoleByName = async (roleName) => {
        return this.doFetch(`${this.getRolesRoute()}/name/${roleName}`, {
            method: 'get',
        });
    };
    getRolesByNames = async (rolesNames) => {
        return this.doFetch(`${this.getRolesRoute()}/names`, {
            method: 'post',
            body: JSON.stringify(rolesNames),
        });
    };
    patchRole = async (roleId, rolePatch) => {
        return this.doFetch(`${this.getRolesRoute()}/${roleId}/patch`, {
            method: 'put',
    ...
    getSchemes = async (scope = '', page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getSchemesRoute()}${buildQueryString({
            scope,
            page,
            per_page: perPage,
        })}`, {
    ...
    createScheme = async (scheme) => {
        ...
        return this.doFetch(`${this.getSchemesRoute()}`, {
            method: 'post',
            body: JSON.stringify(scheme),
        });
    };
    getScheme = async (schemeId) => {
        return this.doFetch(`${this.getSchemesRoute()}/${schemeId}`, {
            method: 'get',
        });
    };
    ...
    patchScheme = async (schemeId, schemePatch) => {
        ...
        return this.doFetch(`${this.getSchemesRoute()}/${schemeId}/patch`, {
            method: 'put',
            body: JSON.stringify(schemePatch),
        });
    };
    getSchemeTeams = async (schemeId, page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getSchemesRoute()}/${schemeId}/teams${buildQueryString({
            page,
            per_page: perPage,
        })}`, {
            method: 'get',
    ...
    getSchemeChannels = async (schemeId, page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getSchemesRoute()}/${schemeId}/channels${buildQueryString({
            page,
            per_page: perPage,
        })}`, {
            method: 'get',
    ...
    installPluginFromUrl = async (pluginDownloadUrl, force = false) => {
        ...
        return this.doFetch(`${this.getPluginsRoute()}/install_from_url${buildQueryString(queryParams)}`, {
            method: 'post',
        });
    };
    getPlugins = async () => {
    ...
    getMarketplacePlugins = async (filter) => {
        return this.doFetch(`${this.getPluginsMarketplaceRoute()}${buildQueryString({
            filter: filter || '',
        })}`, {
            method: 'get',
        });
    ...
    getPluginStatuses = async () => {
        return this.doFetch(`${this.getPluginsRoute()}/statuses`, {
            method: 'get',
        });
    };
    ...
    getWebappPlugins = async () => {
        return this.doFetch(`${this.getPluginsRoute()}/webapp`, {
            method: 'get',
        });
    };
    enablePlugin = async (pluginId) => {
        return this.doFetch(`${this.getPluginRoute(pluginId)}/enable`, {
            method: 'post',
        });
    };
    disablePlugin = async (pluginId) => {
        return this.doFetch(`${this.getPluginRoute(pluginId)}/disable`, {
            method: 'post',
        });
    }; // Groups

    linkGroupSyncable = async (groupID, syncableID, syncableType, patch) => {
        return this.doFetch(`${this.getBaseRoute()}/groups/${groupID}/${syncableType}s/${syncableID}/link`, {
            method: 'post',
            body: JSON.stringify(patch),
        });
    };
    ...
    getGroupSyncables = async (groupID, syncableType) => {
        return this.doFetch(`${this.getBaseRoute()}/groups/${groupID}/${syncableType}s`, {
            method: 'get',
        });
    };
    getGroupMembers = async (groupID, page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getBaseRoute()}/groups/${groupID}/members${buildQueryString({
            page,
            per_page: perPage,
        })}`, {
            method: 'get',
    ...
    getGroup = async (groupID) => {
        return this.doFetch(`${this.getBaseRoute()}/groups/${groupID}`, {
            method: 'get',
        });
    };
    getGroupsNotAssociatedToTeam = async (teamID, q = '', page = 0, perPage = PER_PAGE_DEFAULT) => {
        ...
        return this.doFetch(`${this.getBaseRoute()}/groups${buildQueryString({
    ...
    getGroupsAssociatedToTeam = async (teamID, q = '', page = 0, perPage = PER_PAGE_DEFAULT) => {
        ...
        return this.doFetch(`${this.getBaseRoute()}/teams/${teamID}/groups${buildQueryString({
            page,
            per_page: perPage,
            q,
            include_member_count: true,
    ...
    getGroupsAssociatedToChannel = async (channelID, q = '', page = 0, perPage = PER_PAGE_DEFAULT) => {
        ...
        return this.doFetch(`${this.getBaseRoute()}/channels/${channelID}/groups${buildQueryString({
            page,
            per_page: perPage,
            q,
            include_member_count: true,
    ...
    getAllGroupsAssociatedToTeam = async (teamID) => {
        return this.doFetch(`${this.getBaseRoute()}/teams/${teamID}/groups?paginate=false`, {
            method: 'get',
        });
    };
    getAllGroupsAssociatedToChannel = async (channelID) => {
        return this.doFetch(`${this.getBaseRoute()}/channels/${channelID}/groups?paginate=false`, {
            method: 'get',
        });
    }; // Redirect Location
    ...
    createBot = async (bot) => {
        return this.doFetch(`${this.getBotsRoute()}`, {
            method: 'post',
            body: JSON.stringify(bot),
        });
    };
    patchBot = async (botUserId, botPatch) => {
        return this.doFetch(`${this.getBotRoute(botUserId)}`, {
            method: 'put',
    ...
    getBots = async (page = 0, perPage = PER_PAGE_DEFAULT) => {
        return this.doFetch(`${this.getBotsRoute()}${buildQueryString({
            page,
            per_page: perPage,
        })}`, {
            method: 'get',
    ...
    disableBot = async (botUserId) => {
        return this.doFetch(`${this.getBotRoute(botUserId)}/disable`, {
            method: 'post',
        });
    };
    enableBot = async (botUserId) => {
        return this.doFetch(`${this.getBotRoute(botUserId)}/enable`, {
            method: 'post',
        });
    };
    assignBot = async (botUserId, newOwnerId) => {
        return this.doFetch(`${this.getBotRoute(botUserId)}/assign/${newOwnerId}`, {
            method: 'post',
        });
    };
    teamMembersMinusGroupMembers = async (teamID, groupIDs, page, perPage) => {
        ...
        return this.doFetch(`${this.getTeamRoute(teamID)}/members_minus_group_members?${query}`, {
            method: 'get',
        });
    };
    channelMembersMinusGroupMembers = async (channelID, groupIDs, page, perPage) => {
        const query = `group_ids=${groupIDs.join(',')}&page=${page}&per_page=${perPage}`;
        return this.doFetch(`${this.getChannelRoute(channelID)}/members_minus_group_members?${query}`, {
            method: 'get',
        });
    }; // Client Helpers
    ...
    trackEvent(category, event, props?) {
        ...
        if (!['api_posts_create', 'api_interactive_messages_button_clicked', 'api_interactive_messages_menu_selected', 'api_interactive_messages_dialog_submitted', 'ui_marketplace_download', 'ui_marketplace_configure', 'ui_marketplace_opened', 'ui_marketplace_closed', 'ui_marketplace_search'].includes(event)) {
            return;
        }
