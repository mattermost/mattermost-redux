...
export const createShallowSelector = createSelectorCreator(defaultMemoize, shallowEqual); // isMinimumServerVersion will return true if currentVersion is equal to higher or than the
