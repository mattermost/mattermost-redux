...
export function linkGroupSyncable(groupID: string, syncableID: string, syncableType: SyncableType, patch: SyncablePatch): ActionFunc {
    return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
        dispatch({
            type: GroupTypes.LINK_GROUP_SYNCABLE_REQUEST,
            data: {
                groupID,
                syncableID,
            },
        ...
        try {
            ...
            dispatch(batchActions([{
                type: GroupTypes.LINK_GROUP_SYNCABLE_FAILURE,
                error,
                data: {
                    groupID,
                    syncableID,
        ...
        dispatches.push({
            type: GroupTypes.LINK_GROUP_SYNCABLE_SUCCESS,
            data: null,
        }, {
            type,
            data,
...
export function unlinkGroupSyncable(groupID: string, syncableID: string, syncableType: SyncableType): ActionFunc {
    return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
        dispatch({
            type: GroupTypes.UNLINK_GROUP_SYNCABLE_REQUEST,
            data: {
                groupID,
                syncableID,
            },
        ...
        try {
            ...
            forceLogoutIfNecessary(error, dispatch, getState);
            dispatch(batchActions([{
                type: GroupTypes.UNLINK_GROUP_SYNCABLE_FAILURE,
                error,
                data: {
                    groupID,
                    syncableID,
        ...
        dispatches.push({
            type: GroupTypes.UNLINK_GROUP_SYNCABLE_SUCCESS,
            data: null,
        }, {
            type,
            data,
...
export function getGroupSyncables(groupID: string, syncableType: SyncableType): ActionFunc {
    return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
        dispatch({
            type: GroupTypes.GET_GROUP_SYNCABLES_REQUEST,
            data: {
                groupID,
            },
        });
        ...
        try {
            ...
            forceLogoutIfNecessary(error, dispatch, getState);
            dispatch(batchActions([{
                type: GroupTypes.GET_GROUP_SYNCABLES_FAILURE,
                error,
                data: {
                    groupID,
                },
        ...
        dispatch(batchActions([{
            type: GroupTypes.GET_GROUP_SYNCABLES_SUCCESS,
            data: null,
        }, {
            type,
            data,
...
export function getGroupMembers(groupID: string, page = 0, perPage: number = General.PAGE_SIZE_DEFAULT): ActionFunc {
    return async (dispatch: DispatchFunc, getState: GetStateFunc) => {
        dispatch({
            type: GroupTypes.GET_GROUP_MEMBERS_REQUEST,
            data: {
                groupID,
                page,
                perPage,
        ...
        try {
            ...
            forceLogoutIfNecessary(error, dispatch, getState);
            dispatch(batchActions([{
                type: GroupTypes.GET_GROUP_MEMBERS_FAILURE,
                error,
                data: {
                    groupID,
                    page,
        ...
        dispatch(batchActions([{
            type: GroupTypes.GET_GROUP_MEMBERS_SUCCESS,
            data: null,
        }, {
            type: GroupTypes.RECEIVED_GROUP_MEMBERS,
            group_id: groupID,
            data,
        }]));
        return {
